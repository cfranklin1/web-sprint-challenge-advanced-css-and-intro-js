...
1. How would you describe acessibility on the web to someone new to programming?
    It is made in a way that it is easier for anyone to navigate.
2. Talk about 3 different things you can do to ensure your website is accessible.
    -using semantic html for screen readers
    -using responsive units so images, font sizes and buttons are scalable on a page
    -using visuals in association with alerts or important messages
3. How would you explain the concept of a variable to someone new to programming?
    A variable is just a placeholder for any data. We can use variables in functions to find or use other needed data.
4. What is the purpose of using functions in code?
    Functions use known and unknown data and can implement the data multiple times or whenever necessary.
